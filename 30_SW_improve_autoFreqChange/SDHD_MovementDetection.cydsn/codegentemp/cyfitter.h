...
/* Clk_600 */
#define Clk_600__CFG0 CYREG_CLKDIST_DCFG1_CFG0
#define Clk_600__CFG1 CYREG_CLKDIST_DCFG1_CFG1
#define Clk_600__CFG2 CYREG_CLKDIST_DCFG1_CFG2
#define Clk_600__CFG2_SRC_SEL_MASK 0x07u
#define Clk_600__INDEX 0x01u
#define Clk_600__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clk_600__PM_ACT_MSK 0x02u
#define Clk_600__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clk_600__PM_STBY_MSK 0x02u

/* IRQ_DMA */
#define IRQ_DMA__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define IRQ_DMA__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define IRQ_DMA__INTC_MASK 0x02u
#define IRQ_DMA__INTC_NUMBER 1u
#define IRQ_DMA__INTC_PRIOR_NUM 7u
#define IRQ_DMA__INTC_PRIOR_REG CYREG_NVIC_PRI_1
#define IRQ_DMA__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define IRQ_DMA__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* WaveDAC */
#define WaveDAC_BuffAmp_ABuf__CR CYREG_OPAMP3_CR
#define WaveDAC_BuffAmp_ABuf__MX CYREG_OPAMP3_MX
#define WaveDAC_BuffAmp_ABuf__NPUMP_OPAMP_TR0 CYREG_NPUMP_OPAMP_TR0
#define WaveDAC_BuffAmp_ABuf__PM_ACT_CFG CYREG_PM_ACT_CFG4
#define WaveDAC_BuffAmp_ABuf__PM_ACT_MSK 0x08u
#define WaveDAC_BuffAmp_ABuf__PM_STBY_CFG CYREG_PM_STBY_CFG4
#define WaveDAC_BuffAmp_ABuf__PM_STBY_MSK 0x08u
#define WaveDAC_BuffAmp_ABuf__RSVD CYREG_OPAMP3_RSVD
#define WaveDAC_BuffAmp_ABuf__SW CYREG_OPAMP3_SW
#define WaveDAC_BuffAmp_ABuf__TR0 CYREG_OPAMP3_TR0
#define WaveDAC_BuffAmp_ABuf__TR1 CYREG_OPAMP3_TR1
#define WaveDAC_VDAC8_viDAC8__CR0 CYREG_DAC3_CR0
#define WaveDAC_VDAC8_viDAC8__CR1 CYREG_DAC3_CR1
#define WaveDAC_VDAC8_viDAC8__D CYREG_DAC3_D
#define WaveDAC_VDAC8_viDAC8__PM_ACT_CFG CYREG_PM_ACT_CFG8
#define WaveDAC_VDAC8_viDAC8__PM_ACT_MSK 0x08u
#define WaveDAC_VDAC8_viDAC8__PM_STBY_CFG CYREG_PM_STBY_CFG8
#define WaveDAC_VDAC8_viDAC8__PM_STBY_MSK 0x08u
#define WaveDAC_VDAC8_viDAC8__STROBE CYREG_DAC3_STROBE
#define WaveDAC_VDAC8_viDAC8__SW0 CYREG_DAC3_SW0
#define WaveDAC_VDAC8_viDAC8__SW2 CYREG_DAC3_SW2
#define WaveDAC_VDAC8_viDAC8__SW3 CYREG_DAC3_SW3
#define WaveDAC_VDAC8_viDAC8__SW4 CYREG_DAC3_SW4
#define WaveDAC_VDAC8_viDAC8__TR CYREG_DAC3_TR
#define WaveDAC_VDAC8_viDAC8__TRIM__M1 CYREG_FLSHID_CUST_TABLES_DAC3_M1
#define WaveDAC_VDAC8_viDAC8__TRIM__M2 CYREG_FLSHID_CUST_TABLES_DAC3_M2
#define WaveDAC_VDAC8_viDAC8__TRIM__M3 CYREG_FLSHID_CUST_TABLES_DAC3_M3
#define WaveDAC_VDAC8_viDAC8__TRIM__M4 CYREG_FLSHID_CUST_TABLES_DAC3_M4
#define WaveDAC_VDAC8_viDAC8__TRIM__M5 CYREG_FLSHID_CUST_TABLES_DAC3_M5
#define WaveDAC_VDAC8_viDAC8__TRIM__M6 CYREG_FLSHID_CUST_TABLES_DAC3_M6
#define WaveDAC_VDAC8_viDAC8__TRIM__M7 CYREG_FLSHID_CUST_TABLES_DAC3_M7
#define WaveDAC_VDAC8_viDAC8__TRIM__M8 CYREG_FLSHID_CUST_TABLES_DAC3_M8
#define WaveDAC_VDAC8_viDAC8__TST CYREG_DAC3_TST
...
/* BUTTON_1 */
#define BUTTON_1__0__INTTYPE CYREG_PICU2_INTTYPE4
#define BUTTON_1__0__MASK 0x10u
#define BUTTON_1__0__PC CYREG_PRT2_PC4
#define BUTTON_1__0__PORT 2u
#define BUTTON_1__0__SHIFT 4u
...
#define BUTTON_1__SHIFT 4u
#define BUTTON_1__SLW CYREG_PRT2_SLW

/* IRQ_UART */
#define IRQ_UART__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define IRQ_UART__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define IRQ_UART__INTC_MASK 0x04u
#define IRQ_UART__INTC_NUMBER 2u
#define IRQ_UART__INTC_PRIOR_NUM 7u
#define IRQ_UART__INTC_PRIOR_REG CYREG_NVIC_PRI_2
#define IRQ_UART__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define IRQ_UART__INTC_SET_PD_REG CYREG_NVIC_SETPEND0
...
/* Clk_150KHz */
#define Clk_150KHz__CFG0 CYREG_CLKDIST_DCFG5_CFG0
#define Clk_150KHz__CFG1 CYREG_CLKDIST_DCFG5_CFG1
#define Clk_150KHz__CFG2 CYREG_CLKDIST_DCFG5_CFG2
#define Clk_150KHz__CFG2_SRC_SEL_MASK 0x07u
#define Clk_150KHz__INDEX 0x05u
#define Clk_150KHz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clk_150KHz__PM_ACT_MSK 0x20u
#define Clk_150KHz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clk_150KHz__PM_STBY_MSK 0x20u

/* Clk_200KHz */
#define Clk_200KHz__CFG0 CYREG_CLKDIST_DCFG4_CFG0
#define Clk_200KHz__CFG1 CYREG_CLKDIST_DCFG4_CFG1
#define Clk_200KHz__CFG2 CYREG_CLKDIST_DCFG4_CFG2
#define Clk_200KHz__CFG2_SRC_SEL_MASK 0x07u
#define Clk_200KHz__INDEX 0x04u
#define Clk_200KHz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clk_200KHz__PM_ACT_MSK 0x10u
#define Clk_200KHz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clk_200KHz__PM_STBY_MSK 0x10u

/* Clk_350KHz */
#define Clk_350KHz__CFG0 CYREG_CLKDIST_DCFG3_CFG0
#define Clk_350KHz__CFG1 CYREG_CLKDIST_DCFG3_CFG1
#define Clk_350KHz__CFG2 CYREG_CLKDIST_DCFG3_CFG2
#define Clk_350KHz__CFG2_SRC_SEL_MASK 0x07u
#define Clk_350KHz__INDEX 0x03u
#define Clk_350KHz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clk_350KHz__PM_ACT_MSK 0x08u
#define Clk_350KHz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clk_350KHz__PM_STBY_MSK 0x08u

/* Clk_500Khz */
#define Clk_500Khz__CFG0 CYREG_CLKDIST_DCFG2_CFG0
#define Clk_500Khz__CFG1 CYREG_CLKDIST_DCFG2_CFG1
#define Clk_500Khz__CFG2 CYREG_CLKDIST_DCFG2_CFG2
#define Clk_500Khz__CFG2_SRC_SEL_MASK 0x07u
#define Clk_500Khz__INDEX 0x02u
#define Clk_500Khz__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Clk_500Khz__PM_ACT_MSK 0x04u
#define Clk_500Khz__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Clk_500Khz__PM_STBY_MSK 0x04u

/* DMA_ForAdc */
#define DMA_ForAdc__DRQ_CTL CYREG_IDMUX_DRQ_CTL2
#define DMA_ForAdc__DRQ_NUMBER 10u
#define DMA_ForAdc__NUMBEROF_TDS 0u
#define DMA_ForAdc__PRIORITY 2u
#define DMA_ForAdc__TERMIN_EN 0u
#define DMA_ForAdc__TERMIN_SEL 0u
#define DMA_ForAdc__TERMOUT0_EN 1u
#define DMA_ForAdc__TERMOUT0_SEL 10u
#define DMA_ForAdc__TERMOUT1_EN 0u
#define DMA_ForAdc__TERMOUT1_SEL 0u

/* IRQ_BUTTON */
#define IRQ_BUTTON__INTC_CLR_EN_REG CYREG_NVIC_CLRENA0
#define IRQ_BUTTON__INTC_CLR_PD_REG CYREG_NVIC_CLRPEND0
#define IRQ_BUTTON__INTC_MASK 0x01u
#define IRQ_BUTTON__INTC_NUMBER 0u
#define IRQ_BUTTON__INTC_PRIOR_NUM 7u
#define IRQ_BUTTON__INTC_PRIOR_REG CYREG_NVIC_PRI_0
#define IRQ_BUTTON__INTC_SET_EN_REG CYREG_NVIC_SETENA0
#define IRQ_BUTTON__INTC_SET_PD_REG CYREG_NVIC_SETPEND0

/* InputToAdc */
#define InputToAdc__0__INTTYPE CYREG_PICU15_INTTYPE5
#define InputToAdc__0__MASK 0x20u
#define InputToAdc__0__PC CYREG_IO_PC_PRT15_PC5
#define InputToAdc__0__PORT 15u
#define InputToAdc__0__SHIFT 5u
#define InputToAdc__AG CYREG_PRT15_AG
#define InputToAdc__AMUX CYREG_PRT15_AMUX
#define InputToAdc__BIE CYREG_PRT15_BIE
#define InputToAdc__BIT_MASK CYREG_PRT15_BIT_MASK
#define InputToAdc__BYP CYREG_PRT15_BYP
#define InputToAdc__CTL CYREG_PRT15_CTL
#define InputToAdc__DM0 CYREG_PRT15_DM0
#define InputToAdc__DM1 CYREG_PRT15_DM1
#define InputToAdc__DM2 CYREG_PRT15_DM2
#define InputToAdc__DR CYREG_PRT15_DR
#define InputToAdc__INP_DIS CYREG_PRT15_INP_DIS
#define InputToAdc__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
#define InputToAdc__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define InputToAdc__LCD_EN CYREG_PRT15_LCD_EN
#define InputToAdc__MASK 0x20u
#define InputToAdc__PORT 15u
#define InputToAdc__PRT CYREG_PRT15_PRT
#define InputToAdc__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define InputToAdc__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define InputToAdc__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define InputToAdc__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define InputToAdc__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define InputToAdc__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define InputToAdc__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define InputToAdc__PS CYREG_PRT15_PS
#define InputToAdc__SHIFT 5u
#define InputToAdc__SLW CYREG_PRT15_SLW
...
/* Debounce_Clock */
#define Debounce_Clock__CFG0 CYREG_CLKDIST_DCFG7_CFG0
#define Debounce_Clock__CFG1 CYREG_CLKDIST_DCFG7_CFG1
#define Debounce_Clock__CFG2 CYREG_CLKDIST_DCFG7_CFG2
#define Debounce_Clock__CFG2_SRC_SEL_MASK 0x07u
#define Debounce_Clock__INDEX 0x07u
#define Debounce_Clock__PM_ACT_CFG CYREG_PM_ACT_CFG2
#define Debounce_Clock__PM_ACT_MSK 0x80u
#define Debounce_Clock__PM_STBY_CFG CYREG_PM_STBY_CFG2
#define Debounce_Clock__PM_STBY_MSK 0x80u

/* AnalogOutFromDAC */
#define AnalogOutFromDAC__0__INTTYPE CYREG_PICU15_INTTYPE4
#define AnalogOutFromDAC__0__MASK 0x10u
#define AnalogOutFromDAC__0__PC CYREG_IO_PC_PRT15_PC4
#define AnalogOutFromDAC__0__PORT 15u
#define AnalogOutFromDAC__0__SHIFT 4u
#define AnalogOutFromDAC__AG CYREG_PRT15_AG
#define AnalogOutFromDAC__AMUX CYREG_PRT15_AMUX
#define AnalogOutFromDAC__BIE CYREG_PRT15_BIE
#define AnalogOutFromDAC__BIT_MASK CYREG_PRT15_BIT_MASK
#define AnalogOutFromDAC__BYP CYREG_PRT15_BYP
#define AnalogOutFromDAC__CTL CYREG_PRT15_CTL
#define AnalogOutFromDAC__DM0 CYREG_PRT15_DM0
#define AnalogOutFromDAC__DM1 CYREG_PRT15_DM1
#define AnalogOutFromDAC__DM2 CYREG_PRT15_DM2
#define AnalogOutFromDAC__DR CYREG_PRT15_DR
#define AnalogOutFromDAC__INP_DIS CYREG_PRT15_INP_DIS
#define AnalogOutFromDAC__INTTYPE_BASE CYDEV_PICU_INTTYPE_PICU15_BASE
#define AnalogOutFromDAC__LCD_COM_SEG CYREG_PRT15_LCD_COM_SEG
#define AnalogOutFromDAC__LCD_EN CYREG_PRT15_LCD_EN
#define AnalogOutFromDAC__MASK 0x10u
#define AnalogOutFromDAC__PORT 15u
#define AnalogOutFromDAC__PRT CYREG_PRT15_PRT
#define AnalogOutFromDAC__PRTDSI__CAPS_SEL CYREG_PRT15_CAPS_SEL
#define AnalogOutFromDAC__PRTDSI__DBL_SYNC_IN CYREG_PRT15_DBL_SYNC_IN
#define AnalogOutFromDAC__PRTDSI__OE_SEL0 CYREG_PRT15_OE_SEL0
#define AnalogOutFromDAC__PRTDSI__OE_SEL1 CYREG_PRT15_OE_SEL1
#define AnalogOutFromDAC__PRTDSI__OUT_SEL0 CYREG_PRT15_OUT_SEL0
#define AnalogOutFromDAC__PRTDSI__OUT_SEL1 CYREG_PRT15_OUT_SEL1
#define AnalogOutFromDAC__PRTDSI__SYNC_OUT CYREG_PRT15_SYNC_OUT
#define AnalogOutFromDAC__PS CYREG_PRT15_PS
#define AnalogOutFromDAC__SHIFT 4u
#define AnalogOutFromDAC__SLW CYREG_PRT15_SLW

/* MuxControlRegister */
#define MuxControlRegister_Sync_ctrl_reg__0__MASK 0x01u
#define MuxControlRegister_Sync_ctrl_reg__0__POS 0
#define MuxControlRegister_Sync_ctrl_reg__1__MASK 0x02u
#define MuxControlRegister_Sync_ctrl_reg__1__POS 1
#define MuxControlRegister_Sync_ctrl_reg__16BIT_CONTROL_AUX_CTL_REG CYREG_B0_UDB10_11_ACTL
#define MuxControlRegister_Sync_ctrl_reg__16BIT_CONTROL_CONTROL_REG CYREG_B0_UDB10_11_CTL
#define MuxControlRegister_Sync_ctrl_reg__16BIT_CONTROL_COUNT_REG CYREG_B0_UDB10_11_CTL
#define MuxControlRegister_Sync_ctrl_reg__16BIT_COUNT_CONTROL_REG CYREG_B0_UDB10_11_CTL
#define MuxControlRegister_Sync_ctrl_reg__16BIT_COUNT_COUNT_REG CYREG_B0_UDB10_11_CTL
#define MuxControlRegister_Sync_ctrl_reg__16BIT_MASK_MASK_REG CYREG_B0_UDB10_11_MSK
#define MuxControlRegister_Sync_ctrl_reg__16BIT_MASK_PERIOD_REG CYREG_B0_UDB10_11_MSK
#define MuxControlRegister_Sync_ctrl_reg__16BIT_PERIOD_MASK_REG CYREG_B0_UDB10_11_MSK
#define MuxControlRegister_Sync_ctrl_reg__16BIT_PERIOD_PERIOD_REG CYREG_B0_UDB10_11_MSK
#define MuxControlRegister_Sync_ctrl_reg__2__MASK 0x04u
#define MuxControlRegister_Sync_ctrl_reg__2__POS 2
#define MuxControlRegister_Sync_ctrl_reg__3__MASK 0x08u
#define MuxControlRegister_Sync_ctrl_reg__3__POS 3
#define MuxControlRegister_Sync_ctrl_reg__CONTROL_AUX_CTL_REG CYREG_B0_UDB10_ACTL
#define MuxControlRegister_Sync_ctrl_reg__CONTROL_REG CYREG_B0_UDB10_CTL
#define MuxControlRegister_Sync_ctrl_reg__CONTROL_ST_REG CYREG_B0_UDB10_ST_CTL
#define MuxControlRegister_Sync_ctrl_reg__COUNT_REG CYREG_B0_UDB10_CTL
#define MuxControlRegister_Sync_ctrl_reg__COUNT_ST_REG CYREG_B0_UDB10_ST_CTL
#define MuxControlRegister_Sync_ctrl_reg__MASK 0x0Fu
#define MuxControlRegister_Sync_ctrl_reg__MASK_CTL_AUX_CTL_REG CYREG_B0_UDB10_MSK_ACTL
#define MuxControlRegister_Sync_ctrl_reg__PER_CTL_AUX_CTL_REG CYREG_B0_UDB10_MSK_ACTL
#define MuxControlRegister_Sync_ctrl_reg__PERIOD_REG CYREG_B0_UDB10_MSK

/* Miscellaneous */
#define BCLK__BUS_CLK__HZ 24000000U
#define BCLK__BUS_CLK__KHZ 24000U
#define BCLK__BUS_CLK__MHZ 24U
#define CY_PROJECT_NAME "SDHD_MovementDetection"
