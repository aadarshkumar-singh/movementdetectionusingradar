...
#define WaveDAC_WAVE2_TYPE     (1u)     /* Waveform for wave2 */
...
#define WaveDAC_WAVE1_LENGTH   (1000u)   /* Length for wave1 */
#define WaveDAC_WAVE2_LENGTH   (100u)   /* Length for wave2 */
	
#define WaveDAC_DEFAULT_RANGE    (16u) /* Default DAC range */
...
#define WaveDAC_DAC_RANGE      ((uint8)(16u << 2u) & WaveDAC_RANGE_MASK)
#define WaveDAC_DAC_POL        ((uint8)(16u >> 1u) & WaveDAC_IDIR_MASK)
