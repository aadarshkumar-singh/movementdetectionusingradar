...
void ADC_DelSig_Init(void) 
{
    ...
    ADC_DelSig_DSM_DEM0_REG    = ADC_DelSig_Cfg_DSM_DEM0;
    ADC_DelSig_DSM_DEM1_REG    = ADC_DelSig_Cfg_DSM_DEM1;
    ADC_DelSig_DSM_MISC_REG    = ADC_DelSig_Cfg_DSM_MISC;
    ADC_DelSig_DSM_CLK_REG    |= ADC_DelSig_Cfg_DSM_CLK;
    ADC_DelSig_DSM_REF1_REG    = ADC_DelSig_Cfg_DSM_REF1;

    ADC_DelSig_DSM_OUT0_REG    = ADC_DelSig_Cfg_DSM_OUT0;
    ADC_DelSig_DSM_OUT1_REG    = ADC_DelSig_Cfg_DSM_OUT1;

    ADC_DelSig_DSM_CR0_REG     = ADC_DelSig_Cfg_DSM_CR0;
    ADC_DelSig_DSM_CR1_REG     = ADC_DelSig_Cfg_DSM_CR1;
#if(ADC_DelSig_MI_ENABLE != 0u) /* Enable Modulator Input */
    ADC_DelSig_DSM_CR3_REG     |= ADC_DelSig_DSM_MODBIT_EN;
#else
    ADC_DelSig_DSM_CR3_REG     = ADC_DelSig_Cfg_DSM_CR3;
#endif /* ADC_DelSig_MI_ENABLE != 0u*/    
    ADC_DelSig_DSM_CR8_REG     = ADC_DelSig_Cfg_DSM_CR8;
    ADC_DelSig_DSM_CR9_REG     = ADC_DelSig_Cfg_DSM_CR9;
    ADC_DelSig_DSM_CR13_REG    = ADC_DelSig_Cfg_DSM_CR13;

    ADC_DelSig_DEC_SR_REG      = ADC_DelSig_Cfg_DEC_SR;

    /* Calculate Gain compensation coefficients for all configurations */
    ADC_DelSig_GainCompensation(ADC_DelSig_Cfg_INPUT_RANGE,
                                      ADC_DelSig_Cfg_IDEAL_DEC_GAIN,
                                      ADC_DelSig_Cfg_IDEAL_ODDDEC_GAIN,
                                      ADC_DelSig_Cfg_RESOLUTION,
                                      ADC_DelSig_Cfg);
...
void ADC_DelSig_Enable(void) 
{
    ...
    /* Code to disable the REFBUF0 if reference chosen is External ref */
    #if (((ADC_DelSig_Cfg_REFERENCE == ADC_DelSig_EXT_REF_ON_P03) || \
          (ADC_DelSig_Cfg_REFERENCE == ADC_DelSig_EXT_REF_ON_P32)) || \
        ...
        if (((config == 1u) &&
            ((ADC_DelSig_Cfg_REFERENCE == ADC_DelSig_EXT_REF_ON_P03) ||
             (ADC_DelSig_Cfg_REFERENCE == ADC_DelSig_EXT_REF_ON_P32))) ||
            ((config == 2u) &&
            ((ADC_DelSig_CFG2_REFERENCE == ADC_DelSig_EXT_REF_ON_P03) ||
             (ADC_DelSig_CFG2_REFERENCE == ADC_DelSig_EXT_REF_ON_P32))) ||
    ...
    #if (((ADC_DelSig_Cfg_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) || \
         ((ADC_DelSig_DEFAULT_NUM_CONFIGS > 1) && \
        ...
        if(((config == 1u) &&
            (ADC_DelSig_Cfg_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) &&
            ((ADC_DelSig_Cfg_REFERENCE != ADC_DelSig_EXT_REF_ON_P03) &&
             (ADC_DelSig_Cfg_REFERENCE != ADC_DelSig_EXT_REF_ON_P32))) ||
             ((config == 2u) &&
              (ADC_DelSig_CFG2_INPUT_RANGE == ADC_DelSig_IR_VSSA_TO_2VREF) &&
    ...
    ADC_DelSig_DSM_CR2_REG = ADC_DelSig_Cfg_DSM_CR2;
...
int16 ADC_DelSig_CountsTo_mVolts(int32 adcCounts) 
{
    ...
    #if(ADC_DelSig_Cfg_DEC_DIV != 0)
        if(ADC_DelSig_Config == ADC_DelSig_Cfg)
        {
            adcCounts /= ADC_DelSig_Cfg_DEC_DIV;
        }
    #endif /* ADC_DelSig_Cfg_DEC_DIV */
...
int32 ADC_DelSig_CountsTo_uVolts(int32 adcCounts) 
{
    ...
    if (ADC_DelSig_Config == ADC_DelSig_Cfg)
    {
        resolution = ADC_DelSig_Cfg_RESOLUTION;
        #if(ADC_DelSig_Cfg_DEC_DIV != 0)
            adcCounts /= ADC_DelSig_Cfg_DEC_DIV;
        #endif /* ADC_DelSig_Cfg_DEC_DIV */
    }
    ...
    switch (resolution)
    {
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_12) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_13) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_14) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_15) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_16) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_17) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_18) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_19) || \
        ...
        #if( (ADC_DelSig_Cfg_RESOLUTION == ADC_DelSig__BITS_20) || \
...
static void ADC_DelSig_InitConfig(uint8 config) 
{
    ...
    if (config == 1u)
    {
        ...
        ADC_DelSig_DEC_CR_REG      = ADC_DelSig_Cfg_DEC_CR;
        ADC_DelSig_DEC_SHIFT1_REG  = ADC_DelSig_Cfg_DEC_SHIFT1;
        ADC_DelSig_DEC_SHIFT2_REG  = ADC_DelSig_Cfg_DEC_SHIFT2;
        ADC_DelSig_DEC_DR2_REG     = ADC_DelSig_Cfg_DEC_DR2;
        ADC_DelSig_DEC_DR2H_REG    = ADC_DelSig_Cfg_DEC_DR2H;
        ADC_DelSig_DEC_DR1_REG     = ADC_DelSig_Cfg_DEC_DR1;
        ADC_DelSig_DEC_OCOR_REG    = ADC_DelSig_Cfg_DEC_OCOR;
        ADC_DelSig_DEC_OCORM_REG   = ADC_DelSig_Cfg_DEC_OCORM;
        ADC_DelSig_DEC_OCORH_REG   = ADC_DelSig_Cfg_DEC_OCORH;
        ADC_DelSig_DEC_COHER_REG   = ADC_DelSig_Cfg_DEC_COHER;

        ADC_DelSig_DSM_CR4_REG     = ADC_DelSig_Cfg_DSM_CR4;
        ADC_DelSig_DSM_CR5_REG     = ADC_DelSig_Cfg_DSM_CR5;
        ADC_DelSig_DSM_CR6_REG     = ADC_DelSig_Cfg_DSM_CR6;
        ADC_DelSig_DSM_CR7_REG     = ADC_DelSig_Cfg_DSM_CR7;
        ADC_DelSig_DSM_CR10_REG    = ADC_DelSig_Cfg_DSM_CR10;
        ADC_DelSig_DSM_CR11_REG    = ADC_DelSig_Cfg_DSM_CR11;
        ADC_DelSig_DSM_CR12_REG    = ADC_DelSig_Cfg_DSM_CR12;
        ADC_DelSig_DSM_CR14_REG    = ADC_DelSig_Cfg_DSM_CR14;
        ADC_DelSig_DSM_CR15_REG    = ADC_DelSig_Cfg_DSM_CR15;
        ADC_DelSig_DSM_CR16_REG    = ADC_DelSig_Cfg_DSM_CR16;
        ADC_DelSig_DSM_CR17_REG    = ADC_DelSig_Cfg_DSM_CR17;
        /* Set DSM_REF0_REG by disabling and enabling the PRESS circuit */
        ADC_DelSig_SetDSMRef0Reg(ADC_DelSig_Cfg_DSM_REF0);
        ADC_DelSig_DSM_REF2_REG    = ADC_DelSig_Cfg_DSM_REF2;
        ADC_DelSig_DSM_REF3_REG    = ADC_DelSig_Cfg_DSM_REF3;

        ADC_DelSig_DSM_BUF0_REG    = ADC_DelSig_Cfg_DSM_BUF0;
        ADC_DelSig_DSM_BUF1_REG    = ADC_DelSig_Cfg_DSM_BUF1;
        ADC_DelSig_DSM_BUF2_REG    = ADC_DelSig_Cfg_DSM_BUF2;
        ADC_DelSig_DSM_BUF3_REG    = ADC_DelSig_Cfg_DSM_BUF3;
        ...
        */
        #if(ADC_DelSig_Cfg_RESOLUTION > 16 && \
            ADC_DelSig_Cfg_CONV_MODE == ADC_DelSig_MODE_SINGLE_SAMPLE)
            ADC_DelSig_stopConversion = 1u;
        #endif /* Single sample with resolution above 16 bits. */

        ADC_DelSig_CountsPerVolt = (int32)ADC_DelSig_Cfg_COUNTS_PER_VOLT;

        ADC_DelSig_Ext_CP_Clk_SetDividerRegister(ADC_DelSig_Cfg_CP_CLK_DIVIDER, 1u);

        /* This is only valid if there is an internal clock */
        #if(ADC_DelSig_DEFAULT_INTERNAL_CLK)
            ADC_DelSig_theACLK_SetDividerRegister(ADC_DelSig_Cfg_ADC_CLK_DIVIDER, 1u);
        #endif /* ADC_DelSig_DEFAULT_INTERNAL_CLK */
